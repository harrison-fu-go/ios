...
@objcMembers class CustomSwitch: UIView {
    ...
    func initViews() {
        ...
        //add background
        let bgImageView = UIImageView(image:UIImage(named: "Switches_Off_background"))
        bgImageView.frame = self.bounds
        self.addSubview(bgImageView)
        
        //add selected image view.
        selectedBackgroundImageView = UIImageView(image: UIImage(named: "Switches_On_background"))
        selectedBackgroundImageView?.frame = self.bounds

        //add default tap.
        tapImageView = UIImageView(image: UIImage(named: "swiftOffButton"))
    ...
    @objc func tapView(isAuto: Bool = false) {
        ...
        if !isSelected {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                if success {
                    self.tapImageView?.image = UIImage(named: "swiftOffButton")
