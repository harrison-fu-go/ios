...
//swiftlint:disable mark redundant_optional_initialization explicit_init opening_brace empty_count statement_position force_unwrapping unneeded_parentheses_in_closure_argument operator_usage_whitespace
class OtaTask {
